...
#pragma region RandomFunctionality
	...
	float RandomFloat(float lowerBound = 0.0f, float upperBound = 1.0f);
	float Map(const float number, const float start1, const float stop1, const float start2, const float stop2);
